    ...
    <header className="header">
      <nav className="nav">
        <ul className="nav-list">
          ...
          <li>
            <a href="https://www.linkedin.com/in/rushendra-babu-k-26659832b" target="_blank" rel="noreferrer noopener">
          ...
          <li>
            <a href="https://github.com/Rushendrababu001" target="_blank" rel="noreferrer noopener">
              <svg className="icon" width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
